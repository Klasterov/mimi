...
const FeaturesСols = [
	...
	},
	{
		...
		descr: 'Сигнализация в Умном Доме способна включать на колонки мультирум лай собак, включать и выключать освещение в разных комнатах, блокировать двери, отключать подачу электричества и т.д. возвращаетесь с работы домой, чтоб к этому времени система проветрила квартиру.',
		imageClasses: 'object-[right_center]'
	},
	{
		image: '/images/alarm-system-page/features/3.jpg',
		cap: 'Несколько уровней доступа.',
		descr: 'Для обслуживающего персонала генерируются отдельные коды доступа, не позволяющие отключать систему безопасности в определенных зонах Умного Дома быть телевизор, сенсорная панель управления, ПК, телефон.',
	},
	{
		image: '/images/alarm-system-page/features/4.jpg',
		cap: 'Наличие тревожной кнопки.',
		descr: 'Вы всегда можете активировать сценарий охраны или защиты от протечки нажатием одной кнопки.',
	},
]
const AdvantagesСols = [
	...
	},
	{
		...
		descr: 'В случае тревожной ситуации, вы всегда можете проверить состояние дома, используя камеры.',
		theme: 'dark',
		type: 'notification-anim',
