...
const FeaturesСols = [
	...
	},
	{
		...
		cap: 'Архив записей.',
		descr: 'В любой момент Вы можете самостоятельно изменять настройки системы. Например, задайте время, когда вы возвращаетесь с работы домой, чтобы к этому времени система проветрила квартиру.',
	},
	{
...
const AdvantagesСols = [
	...
	},
	{
		...
		descr: 'Вы можете настроить разные сценарии и связать их между собой.',
		theme: 'light',
