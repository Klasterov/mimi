		...
		<>
			...
			<main>
				...
				<SolutionsFeature
					...
					text="Возможность дистанционного управления, автоматизация процессов и интеграция с другими системами делают эту функцию неотъемлемой частью современного умного дома."
					link="/gates"
