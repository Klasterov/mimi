...
const AdvantagesСols = [
	...
	},
	{
		...
		descr: 'Возможность интегрировать систему Умный дом с современными системами ОПС.',
		theme: 'light',
		...
		<>
			...
			<main>
				<FireHero
					...
					text="Умный дом пришлет пуш-уведомление в случае критической ситуации и активирует необходимые системы ОПС."
				/>
				<FeaturesGrid
