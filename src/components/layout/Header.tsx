...
export default function Header() {
	...
	return (
		<header
			...
			className={`relative z-20 font-helvetica transition-colors duration-400 lg:backdrop-blur-md ${enabled ? 'bg-foreground border-foreground' : 'bg-[#F4F4F4]/95 border-[rgba(69, 69, 69)]/15'} border-b py-2`}
		>
			<div className="max-w-308 mx-auto px-4 flex items-center lg:justify-between gap-5">
				...
				<a href="tel:+740122344555" className={`lg:flex hidden text-[#121212] order-2 lg:order-3 rounded-full shadow-[inset_0_2px_4px_0_rgba(0,0,0,0.06)] pt-2 px-2 pb-2 border min-w-9.5 lg:min-w-auto min-h-9.5 lg:min-h-auto lg:px-4 lg:pt-2 lg:pb-2 items-center justify-center transition duration-400 gap-2 font-medium leading-normal text-[13px] ${enabled ? 'text-white hover:bg-[#00d0ff] hover:text-white border-[#00d0ff]' : 'bg-white hover:bg-[#00d0ff] hover:text-white border-[#EFEFEF]'}`}>
