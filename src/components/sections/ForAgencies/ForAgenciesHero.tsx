...
const cols = [
	{
		icon: RelevanceIcon,
		label: 'Актуальность',
		descr: 'Тренд умного дома становится популярней с каждым днем. Ведь автоматизация значительно повышает уровень комфорта вашего клиента.',
	},
	{
		icon: BenefitIcon,
		label: 'Выгода',
		descr: 'Ежегодно выплачиваем более 6 000 000 р. агентам по партнерской программе. Окажитесь и вы в их числе.',
	},
	{
		icon: DesignIcon,
		label: 'Дизайн',
