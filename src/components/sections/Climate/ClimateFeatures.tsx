...
const features = [
	...
	},
	{
		...
		content: {
			subtitle: "Повышенная концентрация CO₂ в помещении может негативно отразиться на здоровье и самочувствии:",
			list: [
				"головная боль и головокружение;",
				"ощущение сонливости и усталости даже после полноценного сна;",
				"снижение концентрации внимания и работоспособности;",
				"учащённое дыхание и ощущение нехватки воздуха;",
				"ухудшение качества сна, частые пробуждения ночью;",
				"повышенная раздражительность и перепады настроения;",
				"усугубление симптомов астмы и других респираторных заболеваний;",
				"снижение когнитивных функций (скорость реакции, способность к анализу и принятию решений).",
			],
		},
