		...
		<section ref={sectionRef} className="overflow-hidden pt-15 bg-white">
			...
			<div className="max-w-235.5 px-4 pb-22.5 mx-auto flex flex-col items-center text-center">
				...
				<div className="max-w-150 font-helvetica text-[19px] -tracking-[0.01em] leading-normal">
					Приложение сейчас есть практически у всех, и порой при прочих равных условиях компания или услуга выбирается из‑за его удобства. Приложение «Умный дом» нашей компании бесплатное, в отличие от некоторых конкурентов, и вы можете скачать его из Google Play, RuStore или App Store. Введите в поиске MiMiSmart - и вы сразу его найдёте.
				</div>
			</div>
		</section>
	)
