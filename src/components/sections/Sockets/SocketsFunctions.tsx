					...
					>
						...
						<div className="relative h-full flex flex-col">
							...
							<div className="self-start font-helvetica text-[15px] text-brand-gray">
								Вы можете настроить розетку, чтобы включать свет каждый вечер в определенное время или выключить компьютер через несколько минут после использования. Это особенно удобно, когда вам нужно вовремя выключить утюг или лампу.
							</div>
						</div>
					</li>
